...
UINT32 CCP_FlashInit(void) 
{
    ...
    /**************HIGH ONLY BLOCK 10 UNLOCK************/
     ...
     /***************LOW ONLY BLOCK 4 UNLOCK For VIN****2021-6-10*********/
     
    
    flashret = pSetLock( &ssdConfig, LOCK_LOW_PRIMARY, 0x00000007, FLASH_LMLR_PASSWORD);
    
	flashret = pSetLock( &ssdConfig, LOCK_LOW_SECONDARY, 0x00000007, FLASH_SLMLR_PASSWORD);
